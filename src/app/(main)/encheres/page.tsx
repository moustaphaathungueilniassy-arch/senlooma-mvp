  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#2D6A4F] mb-2">Enchères en Direct</h1>
          <p className="text-gray-600">Participez aux enchères et obtenez le meilleur bétail au meilleur prix.</p>
        </div>
        <Link
      ...
      {auctions.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm p-12 text-center border border-gray-100">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-1">Aucune enchère en cours</h3>
